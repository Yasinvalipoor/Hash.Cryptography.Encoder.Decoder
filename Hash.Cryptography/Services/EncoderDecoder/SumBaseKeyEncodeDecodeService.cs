...
public class SumBaseKeyEncodeDecodeService : IEncoderDecoderService
{
    private readonly IKeyGenerationService _keyGenerationService;

    public SumBaseKeyEncodeDecodeService(IKeyGenerationService keyGenerationService)
    {
    ...
    {
        int key = _keyGenerationService.SumBasedKey(From + To); // Initial key based on From and To
        string result = "";
    ...
    {
        int key = _keyGenerationService.SumBasedKey(From + To);
        string result = "";
